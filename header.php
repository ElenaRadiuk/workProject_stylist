        ...
        <div class="container">
            <div class="row">
                ...
                <div class="contacts col-xs-12 col-sm-8 hidden-xs">
                    <p class="phone"><a href="tel:+380977870202">(097) 787 02 02</a>, Харьков, Стамбул, Милан</p>
                </div>
                <div class="contacts contact_mob col-xs-offset-2 col-xs-8 visible-xs text-center">
                    <p class="phone"><a href="tel:+380977870202">(097) 787 02 02</a></p>
                    <p class="phone"><a href="tel:+380663369269">(066) 336 92 69</a></p>
                </div>
            </div>
        </div>
                        ...
                        <nav class="navbar navbar-default">
                            <div class="container">
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand visible-xs" href="/"><img src="<?php bloginfo('template_url'); ?>/img/logo.png" alt="" class="img-responsive"></a>
                                </div>
                ...
                <nav class="navbar navbar-inner navbar-fixed-top">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="/"><img src="<?php bloginfo('template_url'); ?>/img/logo.png" alt="" class="img-responsive"></a>
                        </div>
                        ...
                        <div class="contacts contact_mob visible-xs col-xs-offset-2 col-xs-8 text-center">
                            <p class="phone"><a href="tel:+380977870202">(097) 787 02 02</a></p>
                            <p class="phone"><a href="tel:+380663369269">(066) 336 92 69</a></p>
                        </div>
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
